...
int IMU::setAccelRange(AccelRange range) {
  ...
  case ACCEL_RANGE_2G: {
    ...
    _accelScale = gG * 2.0 / 32767.5; // setting the accel scale to 2G
    break;
  }
  case ACCEL_RANGE_4G: {
    ...
    _accelScale = gG * 4.0 / 32767.5; // setting the accel scale to 4G
    break;
  }
  case ACCEL_RANGE_8G: {
    ...
    _accelScale = gG * 8.0 / 32767.5; // setting the accel scale to 8G
    break;
  }
  case ACCEL_RANGE_16G: {
    ...
    _accelScale = gG * 16.0 / 32767.5; // setting the accel scale to 16G
    break;
  }
  }
  _accelRange = range;
